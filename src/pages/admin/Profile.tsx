...
const AdminProfile = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (avatarFile) {
        ...
        const avatarResponse = await axios.post(`${API_URL}/admin/avatar`, formData, {
          headers: {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      await axios.put(`${API_URL}/admin/password`, {
        ...
        headers: { 'Authorization': `Bearer ${token}` }  // Explicitly set header
      });
  ...
  const handleDeleteAccount = async () => {
    ...
    setIsSaving(true);
    try {
      // Note: This endpoint isn't implemented in the backend yet
      await axios.delete(`${API_URL}/admin/account`);
      logout();
      navigate('/login');
